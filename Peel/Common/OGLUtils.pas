unit OGLUtils;
interface
uses dglOpenGL, SysUtils, Windows, Forms;
    ...
    procedure glkRectXZ(x1,y1,z1,x2,z2:single);
    procedure glkRectYZ(x1,y1,z1,y2,z2:single; DoubleSided:boolean=false);
...
begin
  ...
  with pfd do begin
    ...
    cStencilBits    := 8;                    // Turn on stencil buffer
